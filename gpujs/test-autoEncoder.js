...
let w1 = UTILS.readAsTexture2D("./data/w1", nN, nN);
let b1 = UTILS.readAsTexture1D("./data/b1", nN);

let w2 = UTILS.readAsTexture2D("./data/w2", nN, nN);
let b2 = UTILS.readAsTexture1D("./data/b2", nN);

//let w3 = randomNumbers(nZ, nN);
//let b3 = randomNumbers(nZ, 1);
let w3 = UTILS.readAsTexture2D("./data/w3", nZ, nN);
let b3 = UTILS.readAsTexture1D("./data/b3", nZ);

//let w4 = randomNumbers(nN, nZ);
//let b4 = randomNumbers(nN, 1);
let w4 = UTILS.readAsTexture2D("./data/w4", nN, nZ);
let b4 = UTILS.readAsTexture1D("./data/b4",  nN);

let w5 = UTILS.readAsTexture2D("./data/w5", nN, nN);
let b5 = UTILS.readAsTexture1D("./data/b5",  nN);

let dataIn = UTILS.readAsTexture1D("./data/dataIn", nN);
let target = dataIn;
