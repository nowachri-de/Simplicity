...
class Matrix {
    ...
    multiply(matrixB) {
        ...
        var program = new Program.Program(this.numColumns,this.numRows);
        var textureFactory = new  Program.TextureFactory(program.gl);
...
class MatrixGL {
    constructor(canvasID, matrixA, matrixB) {
        ...
        this.buildRenderer();
        this.doBindings(0);
        this.sourceTexture = this.createTexture(0, this.numRows, this.numColumns, this.matrixA.getTexels());
    ...
    init(canvasID, rows, columns) {
        ...
        if (this.gl === undefined) {
            ...
            this.gl = headlessGL(rows, columns, {
                premultipliedAlpha: false,
                preserveDrawingBuffer: false
            });
    ...
    createReadableTexture(index) {
        ...
        //gl.texImage2D(gl.TEXTURE_2D, /*level*/ 0, gl.RGBA, gl.RGBA, gl.FLOAT, null);
        gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, 12, 12, 0, gl.RGBA, gl.UNSIGNED_BYTE, null);
        //This is the original line
       // gl.texImage2D(gl.TEXTURE_2D, /*level*/ 0,12,12,0, gl.RGBA, gl.RGBA, gl.UNSIGNED_BYTE, null);
...
module.exports.MatrixGL = MatrixGL;
